                ...
                <div class="col-xl-11">
                    <div class="card rounded-3 text-black">
                        <div class="row g-0 gx-1 gy-1">
                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    <div class="card-body-container p-4">
                                        <div class="text-center">
                                            ...
                                            <h4 class="mt-1 mb-5 pb-1" style="color: #002855; font-weight: bold;">E-Paper Content Management System
                                            </h4>
                                        </div>
                                            ...
                                            <div class="row mb-3">
                                                <p class="text-end">
                                                    <a href="ForgotPassword.aspx"
                                                        style="color: #002855; font-weight: bold; text-decoration: none;">Forgot Password?</a>
                                                    <%--<span>Forgot Password?</span>--%>
                                                </p>
                                            </div>
                                            <div class="text-center pt-1 mb-5 pb-1">
                                                <!--ID for LogIn Button-->
                                                <asp:Button ID="LogInBtn" runat="server" Text="Log In" OnClick="LogInBtn_Click" class="btn btn-primary btn-block fa-lg full-width bg-red" ValidationGroup="valgrp1" />
                                            </div>
                            ...
                            <!--Side Image-->
                            <div class="col-lg-5 d-md-none d-xl-flex flex-container">
                                <div class="img-container">
                                    <img src="images/MMCL.png" class="img-fluid" alt="MMCL Logo" />
                                </div>
                            </div>
                        </div>
                    </div>
